_base_ = "./yoloxpose_s_8xb32-300e_coco-640_grayscaled_w_augmentations.py"
work_dir = "runs/augmentations/yoloxpose_l_b16_lr_4e-3_w_augmenations_grayscaled_coco_pretraining"
widen_factor = 1
deepen_factor = 1
checkpoint = (
