...
work_dir = "runs/augmentations/finetuning/dekr_b10_lr1e-3_512x512_grayscaled_w_augmentations_finetuning"
load_from = ""
# runtime
...
model = dict(
    ...
    backbone=dict(
        ...
        extra=dict(
            ...
            stage3=dict(
                num_modules=4, num_branches=3, block="BASIC", num_blocks=(4, 4, 4), num_channels=(32, 64, 128)
            ),
            stage4=dict(
                num_modules=3,
                num_branches=4,
