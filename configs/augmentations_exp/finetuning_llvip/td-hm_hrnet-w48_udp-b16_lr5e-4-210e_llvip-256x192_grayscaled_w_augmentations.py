...
work_dir = "runs/augmentations/finetuning/hrnetw48_udp_b16_lr5e-4_256x192_grayscaled_w_augmenations_finetuning"
load_from = ""
...
# evaluators
val_evaluator = dict(type="CocoMetric", ann_file=data_root + "annotations/finetuning/test_llvip_finetuning_13_kpts.json")
